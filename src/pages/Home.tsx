...
export default function Home() {
  ...
  return (
    <div className="w-full flex-1 flex flex-col">
      ...
      <div className="relative w-full h-[150vh] z-10 bg-transparent">
        <section className="sticky top-0 w-full h-screen bg-white px-6 md:px-12 flex flex-col justify-center overflow-hidden">
          <div className="w-full max-w-[1400px] mx-auto">
            <div className="flex justify-between items-end mb-12">
              <div>
                <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-neutral-900 mb-3 uppercase">Featured Works</h2>
      ...
      {/* "Let's FIKA" Section */}
      <div className="relative w-full h-screen z-20 bg-[#FBFBFB]">
        <section className="sticky top-0 w-full h-screen flex flex-col items-center justify-center px-6 md:px-12 max-w-[1400px] mx-auto overflow-hidden">
          <div className="mb-12 text-center pointer-events-none">
            <h2 className="text-4xl md:text-5xl font-black tracking-tighter text-neutral-200 uppercase mb-4">
              Take a Photo
            </h2>
          </div>
