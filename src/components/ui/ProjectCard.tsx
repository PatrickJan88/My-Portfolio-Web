  ...
  return (
    <Link to={`/projects/${id}`} className={cn("block group", className)}>
      ...
      >
        ...
        <div className="absolute bottom-4 right-4 w-12 h-12 glass-panel-light rounded-full flex items-center justify-center translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 shadow-lg">
