...
const COMPONENT_DEFAULTS: Required<Omit<GlitterWrapProps, "style" | "className">> = {
  particleCount: 200,
  color1: "#F3F7FF",
  color2: "#FF7523",
  color3: "#2F5BF9",
...
export function GlitterWrap(userProps: GlitterWrapProps) {
  ...
  // Latest props, read fresh each frame so control tweaks don't tear down and rebuild
  ...
  const colorCacheRef = useRef({
    ...
    color2: "" as string,
    color3: "" as string,
    parsed1: [243, 247, 255, 1] as [number, number, number, number],
    parsed2: [255, 117, 35, 1] as [number, number, number, number],
    parsed3: [47, 91, 249, 1] as [number, number, number, number],
  });
